        ...
        <div className='lg:h-[99vh] w-full overflow-x-hidden overflow-y-hidden absolute lg:-top-1'>
            <div className='w-full pt-10 sm:pt-20 flex flex-col lg:flex-row justify-around items-center'>
                <div className='flex flex-col gap-4'>
                    <span className='text-2xl sm:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl font-caprasimo font-extrabold text-center transition-opacity ease-in duration-700 opacity-100 hover:opacity-0 relative w-[max-content] before:absolute before:inset-0 before:animate-typewriter before:bg-yellow-500 after:absolute after:inset-0 after:w-[0.125em] after:animate-caret after:bg-black lg:min-h-[100px] flex justify-center items-center'>HI</span>
                    <span className='text-2xl sm:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl  font-caprasimo font-extrabold text-center relative w-[max-content] before:absolute before:inset-0 before:animate-typewriter before:bg-yellow-500 after:absolute after:inset-0 after:w-[0.125em] after:animate-caret after:bg-black lg:min-h-[100px] flex justify-center items-center'>I'm Nitin Gangwani</span>
