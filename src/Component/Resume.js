...
function Resume() {
    ...
    return (
        <div className='absolute top-0 w-[90vw] flex justify-end items-end z-30'>
            <div  id='resume' className='bg-white w-full lg:w-[50vw] p-5 hidden flex-col gap-4 md:mx-auto my-2 overflow-y-scroll h-[95vh]'>
                <div className='flex w-full justify-end items-end sticky'>
               <button onClick={handleResume} className='bg-red-500 text-white font-bold w-fit px-2'>X</button>
               </div>
                <div >
                    <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <ul className='list-disc px-4 md:px-8 text-xs md:text-sm'>
                ...
                <div>
                    ...
                    <div className='flex justify-between items-start'>
                        <div>
                            ...
                            <span className='text-xs md:text-sm'>Bachelor of Technology | Computer Science | CGPA - 8.28</span>
                        </div>
                        <span className='text-sm md:text-base'>Dec’20-Present</span>
                    </div>
                    <div className='flex justify-between items-start'>
                        <div>
                            <h2 className='font-semibold'>Kiddy's Corner Higher Secondary School, Gwalior</h2>
                            <span className='text-xs md:text-sm'>Intermediate | CBSE Board | CGPA - 7.36</span>
                        </div>
                        <span className='text-sm md:text-base'>July’18-June’19</span>
                    </div>
                    <div className='flex justify-between items-start'>
                        <div>
                            <h2 className='font-semibold'>Wendy School Junior College, Gwalior</h2>
                            <span className='text-xs md:text-sm'>Matriculate | ICSE Board | CGPA - 7.64</span>
                        </div>
                        <span className='text-sm md:text-base'>July’17-June’18</span>
                    </div>
                </div>
                <div>
