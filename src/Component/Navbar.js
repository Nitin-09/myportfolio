...
function Navbar(props) {
  ...
  return (
    <div className='w-full sticky mt-2 z-20'>
    <div className='w-full h-16 flex justify-end items-center '>
      <div className='flex items-center justify-center p-3 gap-3 select-none'>
        ...
        <div onClick={handleResume} className='hover:border-4 border-gray-200 rounded-full w-14 h-14 flex justify-center items-center'>
